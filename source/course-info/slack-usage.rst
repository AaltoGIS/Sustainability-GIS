...
We will send an invitation link for all enrolled students to the Slack Team called ``aaltosds2024``.
...
**After accepting the invitation, you can access the course Slack team via this link:** `<http://aaltosds2024.slack.com>`__
