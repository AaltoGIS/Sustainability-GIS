...
**Due date:** Please complete this exercise by **the end of day on Thursday the 17th of February 2022**.

.. admonition:: Exercise 4 - Start your assignment

    You can start working on your personal (private) copy of Exercise by:
      - `accepting the GitHub Classroom assignment <https://classroom.github.com/a/g8l4ZEZf>`__.
...
You can also take a look at the open course copy of `Exercise 4 in the course GitHub repository <https://github.com/Sustainability-GIS-2022/Exercise-4>`__ (does not require logging in).
